    ...
    <style>
        ...
        @media (max-width: 576px) {
            .profile-card {
                ...
                margin: -30px 0.5rem 1rem 0.5rem;
            }
        ...
        @media (max-width: 480px) {
            .profile-card {
                ...
                margin: -25px 0.25rem 0.75rem 0.25rem;
            }
            ...
            <div class="container-fluid" style="overflow-x:hidden;">
                ...
                <div class="profile-card">
                    ...
                    <div class="profile-header">
                        ...
                        <button class="btn btn-primary change-password-btn" data-bs-toggle="modal" data-bs-target="#changePasswordModal"><i class="bi bi-key me-1"></i> Change Password</button>
                    </div>
